...
const headerOld = `<header className="flex flex-col mb-12 py-4 border-b border-gray-200 dark:border-gray-800">
...
const headerNew = `<header className="flex flex-col mb-12 py-4 border-b border-gray-200 dark:border-gray-800">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-indigo-500 rounded-lg flex items-center justify-center shadow-[0_0_15px_rgba(99,102,241,0.3)]">
                <Sliders className="text-white w-6 h-6" />
